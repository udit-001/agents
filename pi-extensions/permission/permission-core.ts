...
// Avoid external dependency in project-local extensions
// Minimal shell-like tokenizer (handles quotes and backslash escapes)
function parse(cmd: string): Array<string> {
  const out: string[] = [];
  let cur = "";
  let q: '"' | "'" | null = null;
  let esc = false;
